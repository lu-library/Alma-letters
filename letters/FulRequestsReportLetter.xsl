            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <table role='presentation' cellspacing="0" cellpadding="5" border="0" style="float:left">
                  ...
                  <xsl:if test="notification_data/hold_shelf_requests/ful_request_interpated">
                    <tr>
                      <h3>The item(s) you requested from <xsl:value-of select="notification_data/organization_unit/name"/>  are now available at the indicated pickup location(s):</h3>
                    </tr>
                    <tr>
                      <td>
                        <table role='presentation' >
          ...
          <xsl:otherwise>
            ...
            <table role='presentation' cellspacing="0" cellpadding="5" border="0" style="float:left">
              ...
              <xsl:if test="notification_data/hold_shelf_requests/ful_request_interpated">
                ...
                <tr>
                  <h3>@@on_hold_shelf_description@@</h3>
                </tr>
                <tr>
                  <td>
                    <table role='presentation' >
