	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<xsl:call-template
					name="head" /> <!-- header.xsl -->
				<xsl:call-template name="senderReceiver" /> <!-- SenderReceiver.xsl -->

				<br />
				<xsl:call-template
					name="toWhomIsConcerned" /> <!-- mailReason.xsl --> @@You_were_specify@@: <br />
				<table
					role='presentation' cellspacing="0" cellpadding="5" border="0">
					<tr>
						<td>
							<br /> @@orderNumber@@ : <br />
		...
		https://ocul-lhd.primo.exlibrisgroup.com/permalink/01OCUL_LHD/ns0jj7/alma<xsl:value-of
							select="notification_data/mms_id" />
					</xsl:attribute>
		Link to Resource </a> 
				<br />
