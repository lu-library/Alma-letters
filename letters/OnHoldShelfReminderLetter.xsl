          ...
          <div class="messageBody">
            ...
            Please note that the following item(s) you requested from <b>
                    ...
                    <tr>
                      <td>
                        <br/>
                                                Please check the website at the pickup library indicated above for service hours and pickup information.<br/>
                        <br/>
              ...
              <table role='presentation' cellspacing="0" cellpadding="5" border="0">
                ...
                <tr>
                  <td>
                    ...
                    <br/>
                    <p>Note: Libraries will be closed for the holiday break from December 20, 2025 - January 4, 2026. All services will resume Monday, January 5, 2026.</p> 
                  </td>
                </tr>
              </table>
              <!-- END OF AFN TODO -->
