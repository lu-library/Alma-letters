				...
				<div class="messageArea">
					<div class="messageBody">
						...
						<table role='presentation'  cellspacing="0" cellpadding="5" border="0">
								<xsl:if test="notification_data/old_terms_exist='true'">
									<tr>
										<td>
											...
											<xsl:if test="notification_data/old_delivey_time != '' and notification_data/old_loan_period = '' and notification_data/old_offer_format = 'Digital'">
												@@from@@
												<xsl:value-of select="notification_data/old_delivey_time" />
												@@hours@@
											</xsl:if>
											...
											<xsl:if test="notification_data/old_loan_period = '' and notification_data/old_offer_format != 'Digital'">
												@@from@@
												<xsl:value-of select="notification_data/old_delivey_time" />
												@@loanPeriodNotExist@@
											</xsl:if>				
								...
								<xsl:if test="notification_data/new_terms_exist='true'">
									<tr>
										<td>
											...
											<xsl:if test="notification_data/ngrs_request/delivery_time != '0' and notification_data/ngrs_request/loan_period = '0' and notification_data/new_offer_format = 'Digital'">
												@@to@@
												<xsl:value-of select="notification_data/ngrs_request/delivery_time" />
												@@hours@@
											</xsl:if>
											...
											<xsl:if test="notification_data/ngrs_request/loan_period = '0' and notification_data/new_offer_format != 'Digital'">
												@@to@@
												<xsl:value-of select="notification_data/ngrs_request/delivery_time" />
												@@loanPeriodNotExist@@
											</xsl:if>		
							...
							<xsl:if test="notification_data/leaving_pua_pod='true'">
								<tr>
									<td>
										<strong>@@leavingPuaPod@@ @@defaultPickupLocation@@</strong>
									</td>
								</tr>
							</xsl:if>
						</table>
