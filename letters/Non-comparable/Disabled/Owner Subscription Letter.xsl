			...
			<xsl:attribute name="style">
				...
				<table>
					...
					<xsl:for-each select="notification_data/creator">	
						<xsl:choose>
							<xsl:when test="first_name!='' or last_name!=''">
								<tr><td><strong>@@mr_mrs@@ </strong><xsl:value-of select="last_name"/></td><td><xsl:value-of select="first_name"/> </td></tr>
							</xsl:when>
							<xsl:otherwise>
						 		<tr><td>@@default_sender@@</td></tr>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:for-each>
